...
export const WhiskeyInventory = withRouter(( props:WhiskeyInvProps ) => {
    console.log(props);
    const { history } = props;
        ...
        <div className={`${classes.root} ${classes.column}`}>
            ...
            <AppBar position="fixed" className={clsx(classes.appBar, {[classes.appBarShift]: open })}>
                <Toolbar className={classes.toolbar}>
                    ...
                    <Button className={classes.toolbar_button} onClick={handleDialogClickOpen}>Add A New Alchohal!</Button>
